        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {servicios.map((s, i) => (
            <Link key={i} href={s.href}>
              <motion.div
                whileHover={{ y: -10 }}
                className="group p-10 bg-white border border-slate-200 border-b-8 border-b-perez-blue rounded-lg shadow-lg hover:shadow-2xl cursor-pointer h-full transition-shadow duration-300"
              >
