...
const servicios = [
  {
    ...
    detalles: "Atendemos urgencias las 24 horas. Utilizamos herramientas de precisión para aperturas de puertas y vehículos sin afectar la estética ni la seguridad original.",
    icon: "🔑",
    imagen: "/services-urgencias.webp" // Ejemplo: Llave en cerradura
  },
  {
    titulo: "Copias de Precisión",
    desc: "Duplicados de llaves comunes y de llaveros magnéticos con tecnología de última generación.",
    detalles: "Realizamos duplicados exactos en el acto. Copiamos llaves de doble paleta, Llaves de candado y configuramos llaveros magnéticos  para edificios con máxima fidelidad.",
    icon: "⚙️",
    imagen: "/services-copias.webp" // Ejemplo: Máquina duplicadora
  },
  {
    titulo: "Seguridad Integral",
    desc: "Instalación de cerrojos de alta seguridad, colocación de cerraduras y cambios de combinación.",
    detalles: "Asesoramiento para blindar tu hogar. Instalación de cerrojos suplementarios de marcas líderes y mantenimiento especializado de cerraduras.",
    icon: "🛡️",
    imagen: "/services-cerradura.webp" // Ejemplo: Escudo de seguridad
  }
];
            ...
            >
              ...
              <div className="p-8 md:p-10">
                ...
                <div className="flex flex-col gap-3">
                  <button 
                    onClick={() => window.open('https://wa.me/5493518148211')}
